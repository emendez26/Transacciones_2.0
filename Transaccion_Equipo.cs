...
{
    public partial class Transaccion_Equipo : Form
    {
        ...
        public Transaccion_Equipo(string formulario)
        {
            InitializeComponent();
        ...
        private void dg_transaccion_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            mostrarDatos();
        }

        private void Transaccion_Equipo_Load(object sender, EventArgs e)
        {
            cargarGrid();
        }
        ...
        private void dg_transaccion_VisibleChanged(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow r in dg_transaccion.Rows)
            {
                ...
                if (tipoFormulario.ToUpper() == "EQUIPOS")
                {
